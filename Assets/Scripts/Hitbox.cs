...
public class Hitbox : ScriptableObject
{
    ...
    public Vector3 startingPointEnemy =>new Vector3(_startingPoint.x * -Mathf.Sign(Enemy.instance.transform.rotation.eulerAngles.y-180), _startingPoint.y, _startingPoint.z);
